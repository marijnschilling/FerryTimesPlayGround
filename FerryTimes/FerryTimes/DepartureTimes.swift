...
class DepartureTimes {
    ...
    func timeTillNearestDeparture(from date: Date = Date()) -> TimeInterval {
        var nextTime = Date()
        let timeIntervalSinceBeginningOfDate = date.timeIntervalSinceBeginningOfDay()
//        print(timeIntervalSinceBeginningOfDate)

        for departureTime in departureTimes {
//            print(departureTime.timeIntervalSinceBeginningOfDay())
            if timeIntervalSinceBeginningOfDate < departureTime.timeIntervalSinceBeginningOfDay() {
                print(date)
                print(departureTime)
